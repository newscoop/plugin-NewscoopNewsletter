...
class LifecycleSubscriber implements EventSubscriberInterface
{
    ...
    {
        return array(
            'plugin.install.newscoop_newsletter_plugin' => array('install', 1),
            'plugin.update.newscoop_newsletter_plugin' => array('update', 1),
            'plugin.remove.newscoop_newsletter_plugin' => array('remove', 1),
        );
    }
